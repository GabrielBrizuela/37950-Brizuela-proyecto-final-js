    ...
    if (response) {
        ...
        <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
          ...
          <input class="shopping-cart-quantity-input shoppingCartItemQuantity" id="${itemProducto}"type="number"
                  ...
                  shoppingCartItems.innerHTML = prodcutoContent
                  productoCardContainer.append(shoppingCartItems)
                  carrito.push(prodcutoContent)
                  shoppingCartItems.querySelector(`.buttonDelete`)
                  .addEventListener(`click`, removeShoppingCartItem);
                  
                  shoppingCartItems.querySelector(`.shoppingCartItemQuantity`)
                  .addEventListener(`change`, quantityChanged);
